...
def test_route():
    ...
    # Testing input
    assert (
        register_law_use_case.registry_param["descricao"] == attributer["description"]
    )
    assert register_law_use_case.registry_param["nome"] == attributer["name"]
...
def test_route_fail():
    ...
    # Testing input
    assert register_law_use_case.registry_param == {}
