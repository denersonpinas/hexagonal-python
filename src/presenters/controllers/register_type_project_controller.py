...
class RegisterTypeProjectController(RouteInterface):
    """Class to define route to register_type_project use case"""

    def __init__(
        self,
        register_type_project_use_case: Type[RegisterTypeProjectInterface],
    ):
        self.register_type_project_use_case = register_type_project_use_case
