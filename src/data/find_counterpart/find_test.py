...
def test_by_id():
    ...
    # Testing inputs
    assert (
        counterpart_repo.select_counterpart_params["counterpart_id"] == attributes["id"]
    )
...
def test_by_required():
    ...
    # Testing inputs
    assert (
        counterpart_repo.select_counterpart_params["required"] == attributes["required"]
    )
...
def test_by_default():
    ...
    # Testing inputs
    assert (
        counterpart_repo.select_counterpart_params["default"] == attributes["default"]
    )
...
def test_by_id_and_required():
    ...
    response = find_counterpart.by_id_and_required(
        counterpart_id=attributes["id"], required=attributes["required"]
    )
...
def test_by_id_and_dafault():
    ...
    response = find_counterpart.by_id_and_default(
        counterpart_id=attributes["id"], default=attributes["default"]
    )
...
def test_by_required_and_default():
    ...
    response = find_counterpart.by_required_and_default(
        required=attributes["required"], default=attributes["default"]
    )
