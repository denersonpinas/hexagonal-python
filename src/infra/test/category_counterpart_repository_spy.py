...
class CategoryCounterpartRepositorySpy(CategoryCounterpartRepositoryInterface):
    ...
    def select_category_counterpart(
        ...
        self.select_category_counterpart_params["subcategoria_id"] = subcategoria_id
